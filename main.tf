...
#   to_port                  = 80
#   protocol                 = "tcp"
#   source_security_group_id = module.security-groups.security_group_id["APP_EC2_sg"]
#   security_group_id        = module.security-groups.security_group_id["database_sg"]
...
#   to_port                  = 22
#   protocol                 = "tcp"
#   source_security_group_id = module.security-groups.security_group_id["bastion_sg"]
#   security_group_id        = module.security-groups.security_group_id["APP_EC2_sg"]
# }